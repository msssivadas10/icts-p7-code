...
def run_pipeline(config_fname):
    ...
    for i in range( src_size // chunk_size + 1 ):
        ...
        # delta_num, delta_num_cross, delta_den, deltaalt_num, deltaalt_num_cross, delta_npairs = calculate_dsigma_increments_vector_l( src_i, lenses, nnid, r_edges, z_diff )
        delta_num, delta_num_cross, delta_den, delta_npairs = calculate_dsigma_increments_vector_l( src_i, lenses, nnid, r_edges, z_diff )
